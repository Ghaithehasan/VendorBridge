...
.forgot-link{display:block;text-align:center;margin-top:14px;font-family:'DM Sans',sans-serif;font-size:12px;color:#9ca3af;text-decoration:none;transition:color 0.15s}
.forgot-link:hover{color:#0f172a}
...
.remember-row span{font-family:'DM Sans',sans-serif;font-size:12px;color:#6b7280}
</style>
...
<div class="login-shell">
    ...
    <div class="lc">
      ...
      <div class="hero">
        ...
        <div class="hero-title">
          Engineered<br>for <em>Precision</em><br>Procurement.
        </div>
        <div class="hero-sub">
          Replace manual factory workflows with structured digital control — full traceability from PR to RFQ.
        </div>
      </div>
      <div class="stats">
  ...
  <div class="right">
    ...
    <div class="form-sub">Use your assigned factory credentials to access PR and RFQ workflow controls.</div>
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="remember-row">
        <input id="remember_me" type="checkbox" name="remember"
          class="rounded border-slate-300" style="accent-color:#080d1a;width:13px;height:13px">
